...
class UserController {
    ...
    getUserId(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            try {
                const users = yield prisma_1.default.user.findUnique({ where: { id: (_a = req.user) === null || _a === void 0 ? void 0 : _a.id } });
    ...
    editAvatar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (!req.file)
                    throw { message: "No File Detected" };
                const link = `http://localhost:8000/api/public/avatar/${req.file.filename}`;
                yield prisma_1.default.user.update({ data: { avatar: link }, where: { id: (_a = req.user) === null || _a === void 0 ? void 0 : _a.id } });
