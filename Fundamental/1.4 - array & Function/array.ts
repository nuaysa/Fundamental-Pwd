...
console.log (oddNumber.find((item) => item == 3))//return isi
console.log (oddNumber.findIndex((item) => item == 1))//return index
console.log (oddNumber.includes(3))//return boolean
